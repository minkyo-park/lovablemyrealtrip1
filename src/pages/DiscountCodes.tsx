...
const schema = {
  ...
  "@type": "ItemList",
  "name": "마이리얼트립 할인코드 목록 2026년 9월",
  "description": "2026년 9월 현재 사용 가능한 마이리얼트립 공식 할인코드 전체 목록",
  "numberOfItems": 8,
  "itemListElement": [
    ...
    <>
      ...
      <section className="navy-gradient py-12 md:py-16">
        <div className="container mx-auto px-4 text-center">
          <span className="badge-accent mb-4 inline-block">2026년 9월 업데이트</span>
      ...
      <section className="py-12 bg-muted/50">
        <div className="container mx-auto px-4">
          ...
          <p className="section-subtitle">해외 투어·티켓 상품에만 사용 가능한 전용 할인 쿠폰입니다. 발급 기간: 2026년 9월 1일~9월 30일, 사용 기간: 발급일로부터 7일 이내. 선착순 한정 수량으로 예산 소진 시 별도 안내 없이 종료됩니다.</p>
          ...
          <div className="card-elevated p-6 mb-8">
            ...
            <p className="text-xs text-muted-foreground mt-4">
              발급 기간 2026.09.01~09.30 · 사용 기간 발급일로부터 7일 이내 · 선착순 한정 수량(예산 소진 시 별도 안내 없이 종료) · 일부 상품 사용 불가 · 타 쿠폰 중복 사용 불가.
            </p>
