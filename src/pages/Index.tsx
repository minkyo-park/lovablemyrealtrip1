...
const schema = [
  {
    ...
    "description": "마이리얼트립 할인코드 & 프로모션 코드 완전 정리",
    "inLanguage": "ko",
  },
  {
    "@context": "https://schema.org",
    ...
    "mainEntity": [
      ...
      {
        "@type": "Question",
        "name": "2026년 4월 사용 가능한 마이리얼트립 할인코드는?",
        "acceptedAnswer": {
          "@type": "Answer",
...
export default function Index() {
  return (
    <>
      <SchemaOrg
        schema={schema}
        title="마이리얼트립 할인쿠폰코드 4월"
        description="2026년 4월 최신 마이리얼트립 할인쿠폰코드 총정리. 최대 5만원 할인코드, 프로모션 쿠폰을 확인하고 바로 적용하세요."
      ...
      <section className="hero-gradient py-16 md:py-24 relative overflow-hidden">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1 text-center md:text-left">
            <span className="badge-accent mb-4 inline-block">2026년 4월 최신</span>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          ...
          <p className="section-subtitle text-center">2026년 4월 기준, 검증된 마이리얼트립 핫딜 쿠폰코드입니다.</p>
