...
const schema = [
  {
    ...
    "description": "9월 마이리얼트립 쿠폰 총정리! 최신 할인코드와 마이리얼트립 쿠폰 받는 법까지 한 번에. 지금 바로 쓸 수 있는 쿠폰 모음, 9월 여행 예약 전 할인쿠폰 받아서 더 저렴하게 예약하세요!",
    "inLanguage": "ko",
  },
  {
    "@context": "https://schema.org",
    ...
    "mainEntity": [
      ...
      {
        "@type": "Question",
        "name": "2026년 9월 사용 가능한 마이리얼트립 할인코드는?",
        "acceptedAnswer": {
          "@type": "Answer",
    ...
    <>
      ...
      <section className="hero-gradient py-16 md:py-24 relative overflow-hidden">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1 text-center md:text-left">
            <span className="badge-accent mb-4 inline-block">2026년 9월 최신</span>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          ...
          <p className="section-subtitle text-center">2026년 9월 기준, 검증된 마이리얼트립 핫딜 쿠폰코드입니다.</p>
