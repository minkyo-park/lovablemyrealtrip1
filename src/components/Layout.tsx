          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-sm opacity-80">
                <a href="https://xn--bk1b700b1cz40buif.com/dealstore/myrealtrip/" target="_blank" rel="noopener noreferrer" className="text-secondary-foreground hover:underline">마이리얼트립 쿠폰</a>과 최신 프로모션 정보를 한곳에서 확인하세요. 2026년 8월 기준 최신 정보를 제공합니다.
              </p>
            </div>
            <div>
